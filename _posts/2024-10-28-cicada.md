...
![port](assets/cicada/port.png)

## Introducción

Cicada es una máquina Windows de dificultad fácil centrada en enumeración SMB y Active Directory. 
...
Listando los recursos del usuarios no encontramos nada de gran valor, así que probamos para ver si podemos autenticarnos usando el protocolo **LDAP** y tenemos éxito. 
